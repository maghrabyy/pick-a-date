...
import ashrafleoImg from '../src/assets/ashrf.png';
...
export const AskForADate = ({yesClickedCallbk}:AskForADateType)=>{
    ...
    return <div className="ask-for-a-date px-2 flex flex-col">
    ...
    <img src={ashrafleoImg} width={250} className="self-center" alt="ashraf leo" />
</div>
} 